...
## S
- [Pancake Sorting](AllSolutions/Pancake Sorting.py)
- [Edit Distance](AllSolutions/Edit Distance.py)
- [Palindrome Pairs](AllSolutions/Palindrome Pairs.py)
- [Available Captures for Rook](AllSolutions/Available Captures for Rook.py)
- [Encode and Decode Strings](AllSolutions/Encode and Decode Strings.py)
